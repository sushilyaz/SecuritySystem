#include <jni.h>
#include "com_suhoi_util_FileAccessControl.h"
#include <windows.h>
#include <aclapi.h>
#include <vector>
#include <string>
...
bool RemoveBlock(LPCWSTR path, PSID pAdminSID) {
  ...
  return result;
      ...
      JNIEXPORT jboolean JNICALL Java_com_suhoi_util_FileAccessControl_blockAccess(JNIEnv *env, jobject obj) {
          return BlockAccess() ? JNI_TRUE : JNI_FALSE;
      }

      JNIEXPORT jboolean JNICALL Java_com_suhoi_util_FileAccessControl_allowAccess(JNIEnv *env, jobject obj) {
          return AllowAccess() ? JNI_TRUE : JNI_FALSE;
      }

      JNIEXPORT jboolean JNICALL Java_com_suhoi_util_FileAccessControl_unblockSpecific(JNIEnv *env, jobject obj, jstring jPath) {
